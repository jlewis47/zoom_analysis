...
# zoom_512_target = 2050, 1, 2.005e13, 0.38182679, 0.14534359, 0.14002028, 0.00585990
...
# combined_dist = pos_dist + mass_dist + rvir_dist
combined_dist = pos_dist  # + mass_dist + rvir_dist
...
ax[-1].legend(framealpha=0.0, ncol=2, fontsize=12)
...
fig.savefig("sfhs_comp_bondi_HAGNgaltree.png")
