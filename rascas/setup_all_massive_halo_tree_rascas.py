...
mlim = 1e10  # galaxies must be at least this mass to be tracked
...
true_start_snap = sim.get_closest_snap(zed=zed_target)
true_start_zed = sim.get_snap_exps(true_start_snap)

gal_dict = get_gal_props_snap(sim.path, true_start_snap)

massive_gals = gal_dict["mass"] > mlim

massive_gal_host_hids = gal_dict["host hid"][massive_gals]

for hid_start in massive_gal_host_hids:
